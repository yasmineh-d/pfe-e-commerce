...
<html lang="en">
  <head>
    ...
    <style>
      /* 
        ===== START OF CORRECTION =====
        - 7ayedna text-align: center men l'form kamla.
        - Zidna text-align: center ghir l lien bo7do.
      */
  ...
  <body>
    ...
    <div class="auth-container">
      <!-- ======================================================= -->
      <!--          LJIHA LISSRYA: FORM DYAL SIGN IN            -->
      <!-- ======================================================= -->
        ...
        <div class="footer-main">
          ...
          <div class="footer-column">
            ...
            <ul>
              ...
              <li>
                <a href="#"
                  >Production Monitoring and Inspection Services</a
                >
              </li>
            </ul>
          </div>
